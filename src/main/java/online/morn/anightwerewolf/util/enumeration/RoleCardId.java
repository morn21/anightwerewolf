...
public class RoleCardId {
    ...
    public static final String TANNER = "TANNER";//皮匠 orderNum:7
    public static final String SEER = "SEER";//预言家 orderNum:8
    public static final String APPRENTICE_SEER = "APPRENTICE_SEER";//见习预言家 orderNum:9
    public static final String ROBBER = "ROBBER";//强盗 orderNum:10
    public static final String WITCH = "WITCH";//女巫 orderNum:11
    public static final String TROUBLEMAKER = "TROUBLEMAKER";//捣蛋鬼 orderNum:12
